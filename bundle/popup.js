...
(function (modules) {
    ...
    8: function (module,
        ...
        function generateListView(entity) {
            ...
            if (isLoading) status = `<span class="text-primary">\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430: ${loadedTrackSizeStr} \u0438\u0437 [${totalTrackMinSizeStr} - ${totalTrackMaxSizeStr}]</span>`;
            else if (isInterrupted) status = '<span class="text-danger">\u041e\u043f\u0430\u043d\u044c\u043a\u0438... \u041f\u043e\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u043d\u0430\u0436\u0430\u0442\u044c \u0433\u043e\u043b\u0443\u0431\u0443\u044e \u043a\u043d\u043e\u043f\u043a\u0443 \u0441\u043f\u0440\u0430\u0432\u0430 &rarr;</span>';
